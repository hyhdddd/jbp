 ...
 <%
  ...
  %>
		...
		<div class="pagelist">	
			...
			mychoice=10
			link_url = "a_result_list_2_1.asp?start_date="&start_date&"&end_date="&end_date&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
