  ...
  filename="전체실적관리_일자별 개통현황(20"&Left(Create_code(),10)&").xls"		
...
<body leftmargin=0 topmargin=0 bgcolor="#FFFFFF" text="#000000">
		...
		<tr height=30>                     
			<td width="150" class="table_header"> 날 짜 </font></td>
			<% For i=1 To article_cnt %>
			<td width="120" class="table_header"> <%=article_name(i)%> </td>
			<% Next %>
			<td width="120" class="table_header">합계 </td>
		</tr>    					
