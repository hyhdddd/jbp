...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  Else
  strSql_txt = strSql_txt & " and (A.g_yuchi_m_id in (select m_id from emp_list where o_code='"&o_code&"'))"
  End if
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "a_result_list_3_1.asp?start_date="&start_date&"&end_date="&end_date&"&g_article_idx1="&g_article_idx1&"&g_article_idx2="&g_article_idx2&"&dealer_code="&dealer_code&"&"
			%>
