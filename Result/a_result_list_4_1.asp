...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  strSql_txt = "	and (A.g_date_gaetong>='"&start_date&" 00:00:00.000') "
  strSql_txt = strSql_txt & "	and (A.g_date_gaetong<='"&end_date&" 23:59:59.000') "	

  If dealer_code<>"" then
  strSql_txt = strSql_txt & " and (A.g_yuchi_m_id in (select m_id from emp_list where m_dealer_code='"&dealer_code&"'))"
  Else
  strSql_txt = strSql_txt & " and (A.g_yuchi_m_id in (select m_id from emp_list where 1=1 ))"
  End if
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "a_result_list_4_1.asp?start_date="&start_date&"&end_date="&end_date&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
