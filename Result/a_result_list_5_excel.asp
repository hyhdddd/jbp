  ...
  <%
  filename="전체실적관리_본사사원 유치현황(20"&Left(Create_code(),10)&").xls"		
  Response.addHeader "Content-Disposition","attachment;filename="&filename

  Login_chk(Session_m_id)
  
  g_article_idx1		= WORD_CHANGE(Request("g_article_idx1"),10)
  start_date			= WORD_CHANGE(Request("start_date"),10)
...
<body leftmargin=0 topmargin=0 bgcolor="#FFFFFF" text="#000000">
		...
		<tr height=30> 
			<td>검색 내용 : 본사 사원별 유치현황 (<span class='red'><%=sawon_txt%></span>)</td>
		</tr>				
		<tr height=30> 
...
<%
  strSql = "select m_name, m_id from emp_list "
