...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<tr height=30> 
			<td> 검색 내용 : 본사 사원별 개통현황 (<%=m_name%>님) </td>
		</tr>	
		<tr height=30>
 ...
 <%
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "a_result_list_6_1.asp?start_date="&start_date&"&end_date="&end_date&"&g_article_idx1="&g_article_idx1&"&g_article_idx2="&g_article_idx2&"&m_name="&m_name&"&m_id="&m_id&"&"
			%>
