...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<tr height="30"> 
			...
			<a href="/result/a_result_list_7_excel.asp?g_article_idx1=<%=g_article_idx1%>&start_date=<%=start_date%>&end_date=<%=end_date%>"><img src="/images/button/btn_excel.gif" border=0 align="absmiddle"></a>
			</td>
		</tr>
		<tr>
			<td align='right'>
				<form name="frm" method="post" action="a_result_list_7.asp">
...
<%
  strSql = "select dealer_code, dealer_name from dealer_info where dealer_ingea='Y' order by dealer_name asc "
