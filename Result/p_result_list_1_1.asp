...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  strsql = stRsql & "					and year(g_date_yuchi)='"&start_year&"' "
  strSql = strSql & "					and month(g_date_yuchi)='"&start_month&"' "
  strSql = strSql & "					and day(g_date_yuchi)='"&start_day&"' "
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "p_result_list_1_1.asp?start_year="&start_year&"&start_month="&start_month&"&start_day="&start_day&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
