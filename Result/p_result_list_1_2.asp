 ...
 <%
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "p_result_list_1_2.asp?start_date="&start_date&"&end_date="&end_date&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
