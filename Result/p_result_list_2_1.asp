...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<tr height=30> 
			<td> 검색 내용 : 나의 일자별 개통현황 </td>
		</tr>	
		<tr height=30>
			<td> 검색 기간 : (<%=start_year%>년 <%=start_month%>월 <%=start_day%>일)</td>		
		</tr>
		<tr height=30> 
 ...
 <%
  ...
  strsql = stRsql & "					and year(g_date_gaetong)='"&start_year&"' "
  strSql = strSql & "					and month(g_date_gaetong)='"&start_month&"' "
  strSql = strSql & "					and day(g_date_gaetong)='"&start_day&"' "
  ...
  %>
				...
				<div class="pagelist">		
					...
					mychoice=10
					link_url = "p_result_list_2_1.asp?start_year="&start_year&"&start_month="&start_month&"&start_day="&start_day&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
					%>
