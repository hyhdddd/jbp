		...
		<tr height=30> 
			...
			<td>
				<select name="result" class="txtbox" size=15 style="width:650px;">
					<option value="1"> 나의 검색 일자별 유치현황 </option>
					<option value="2"> 나의 검색 일자별 개통현황 </option>
				</select> 
			</td>		          
		</tr>
		<tr height=30>
			<td colspan='2' align='center'> 
				<span onClick="result_search01('frm_p_result');"><img src="/images/button/btn_search.gif" align='absmiddle' border=0></span>
			</td>  
		</tr>
		</table>									
		</form>	
