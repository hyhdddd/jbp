...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  strSql = strSql & "				where g_yuchi_m_id in (select m_id from emp_list where m_dealer_code in (select m_dealer_code from emp_list where m_id='"&session_m_id&"'))"
  strSql = strSql & "					and (A.g_article_idx1="& g_article_idx1&") "
  strSql = strSql & "					and (A.g_date_yuchi>='"&start_date&" 00:00:00.000') "
  strSql = strSql & "					and (A.g_date_yuchi<='"&end_date&" 23:59:59.000') "	
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "y_result_list_1_1.asp?start_year="&start_year&"&start_month="&start_month&"&start_day="&start_day&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
