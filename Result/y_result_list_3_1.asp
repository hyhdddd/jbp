...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  strSql_txt = strSql_txt & "	and (g_date_yuchi>='"&start_date&" 00:00:00.000') "
  ...
  %>
		<tr height=25>
			<td class='con5' colspan='8'> 고객 등록상품이 없습니다. </td>
		</tr>
  <%
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "y_result_list_3_1.asp?start_date="&start_date&"&end_date="&end_date&"&m_id="&m_id&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
