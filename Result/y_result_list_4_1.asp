...
<tr bgcolor="#FFFFFF"  align='center'> 
 ...
 <%
  ...
  strSql_txt = strSql_txt & "	and (A.g_date_gaetong>='"&start_date&" 00:00:00.000') "
  strSql_txt = strSql_txt & "	and (A.g_date_gaetong<='"&end_date&" 23:59:59.000') "	
  If m_id<>"" then
  strSql_txt = strSql_txt & "	and (A.g_yuchi_m_id='"&m_id&"') "	
  End if
  ...
  %>
		...
		<div class="pagelist">		
			...
			mychoice=10
			link_url = "y_result_list_4_1.asp?start_date="&start_date&"&end_date="&end_date&"&m_id="&m_id&"&g_article_idx1="&g_article_idx1 &"&g_article_idx2="&g_article_idx2&"&"
			%>
