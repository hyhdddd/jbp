		...
		<tr height=30> 
			...
			<td>
				<select name="result" class="txtbox" size=15 style="width:650px;">
					<option value="1"> 일자별 유치현황 </option>
					<option value="2"> 일자별 개통현황 </option>
					<option value="3"> 사원별 유치현황 </option>
					<option value="4"> 사원별 개통현황 </option>
				</select> 
			</td>		          
		</tr>
		<tr height=30>
			<td colspan='2' align='center'> 
				<span onClick="result_search03('frm_y_result');"><img src="/images/button/btn_search.gif" align='absmiddle' border=0></span>
			</td>  
		</tr>
		</table>									
		</form>	
