...
<tr height='400' valign='top'> 
	<td>
		...
		<form id="frm_board" name="frm_board" action="a_gift_regist_ok.asp" METHOD="POST">
  ...
  <% End If %>
		...
		<tr height=30> 
			...
			<td width='85%' class="list_TLBR_left">
				...
				<option value="신청" <% If gift_status="신청" Then %> selected <% End If %>> 신청 </option>
				<option value="접수" <% If gift_status="접수" Then %> selected <% End If %>> 접수 </option>
				<option value="완료" <% If gift_status="완료" Then %> selected <% End If %>> 완료 </option>
				</select>
			</td>
		</tr>
		...
		<div class="alignRight">      
			<a href="a_gift_list.asp?page=<%=page%>&nowblock=<%=nowblock%>&<%=s_link_txt%>"><span class="btn_m_white01"> 목록으로</span></a> 
