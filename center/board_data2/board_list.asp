  ...
  Login_chk(Session_m_id)
   ...
   if ad_e_data2="N" then
	Alert_url session_m_name &" 님은 거래처 자료실 권한이 없습니다. 관리자에게 문의하세요!","/main.asp"
  end If
...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center' height='400'>
		...
		<tr height=28>             
			<td align='left' colspan='3' style='border-style:none'>
			...
			<td align="right" colspan='3'>
				<% if ad_e_data2="W" or ad_e_data2="E" or ad_e_data2="A" then %>
  ...
  %>
		<tr height=30>
			<td align="center" class="con5" colspan='6'> 글이 존재하지 않습니다.</td>	
		</tr>		
  <%
  else
  ...
  %>			  
		<tr height=30>
			<td class="con5"><%=i%></td>	
			<td class="con2">
				<a href="board_content.asp?board_idx=<%=board_idx%>&tname=<%=tname%>&page=<%=page%>"><%=board_title%> <%=new1%></a></td>	
