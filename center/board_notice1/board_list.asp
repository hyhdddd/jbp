  ...
  if ad_e_notice1="N" then
	Alert_url session_m_name &" 님은 사내 공지사항 권한이 없습니다. 관리자에게 문의하세요!","/main.asp"
  end If
...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center' height='400'>
		...
		<div class="sub_title"><img src="/images/common/sub07_t01.gif"></div>
		...
		<tr height=28>             
			...
			<td align="right" colspan='3'>
				<% if ad_e_notice1="W" or ad_e_notice1="E" or ad_e_notice1="A" then %>
					<a href='board_write.asp?tname=<%=tname%>'>
					<img src="/images/button/btn_new.gif" align='absmiddle'  border="0"></a>
				<% else %>
					<a href ='javascript:alert("<%=session_m_name%> 님은 사내공지사항 등록권한이 없습니다. 관리자에 문의하세요!");'><img src="/images/button/btn_new.gif" border="0"></a> 
				<% end if %>   
			</td>
		</tr>
		</table>
		...
		<tr height=30>             
			...
			<td class="head" width=600>제  목</td>
			<td class="head">등록인</td>
			<td width=50  class="head">파일</td>
			<td class="head" width=50>조회수</td>
			<td class="head" width=60>등록일</td>
		</tr>
  <% 
