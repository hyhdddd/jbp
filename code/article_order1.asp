...
<tr bgcolor="#FFFFFF"  height='400'> 
	<td valign='top' align='center'>
		...
		<form name="frm" method="post" action="article_order1.asp">
...
%>
		<tr height=30>
			...
			<td class="con4">
				<a href="article_order1_ok.asp?article_step1=<%=article_step1%>&article_idx=<%=article_idx%>&article_order=<%=article_order%>&chk=U&page=<%=page%>"><img src='/images/button/btn_up.gif' border=0 align='absmiddle'></a>
				&nbsp;|&nbsp;
				<a href="article_order1_ok.asp?article_step1=<%=article_step1%>&article_idx=<%=article_idx%>&article_order=<%=article_order%>&chk=D&page=<%=page%>"><img src='/images/button/btn_down.gif' border=0 align='absmiddle'></a>
			</td>
		</tr>
<%
