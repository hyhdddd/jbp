 <%
  ...
  If objRs(0)="0" Or objRs(0)=0  Then
  Else
	Message_txt3 = "파트너 신청 정보 ("&objRs(0)&"건), "
	Message_chk = "X"
  End If
  ...
  If objRs(0)="0" Or objRs(0)=0  Then
  Else
	Message_txt4 = "사원관리 ("&objRs(0)&"건)  "
	Message_chk = "X"
  End If  
  
  If Message_chk="X" Then
  	Alert_back Message_txt1 & " " & Message_txt2 & " " & Message_txt3 & " "& Message_txt4 &" 에서 코드를 사용하고 있으므로 삭제할 수 없습니다."
	Response.end
  Else
	...
	Alert_url " 코드를 삭제했습니다.","bank_list.asp"
  End if  
  %>