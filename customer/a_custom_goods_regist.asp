	...
	<td>
		...
		<tr>
			...
			<td> 
				...
				<span title="클릭하시면 주민번호가 복사됩니다." onclick="copy_clipboard('<%=c_jumin1%><%=c_jumin2%>');"><img src="/images/button/btn_copy.gif" align='absmiddle' onmouseover="this.style.cursor='hand';"></span>
		...
		<Tr>
			...
			<td>
				...
				<% For i=0 To 59 %>
					...
					<% Next %>
				</select>(<span class='red'>등록:<%=g_writeday%></span>)
			</td>
		</tr>
		<Tr>
			<th>상품선택</th>
		...
		<tr>
			...
			<td>
				...
				<img src="/images/Common/icon_help.gif" border="0" align='absmiddle' onmouseover="this.style.cursor='hand';" onclick="alert('SMS전송 - 유치자에게 고객상태 정보를 문자메세지로 전송할 수 있는 기능입니다.');">
			</td>	
		</tr>
		<tr>
			<th> 지역 선택 </th>
		...
		<tr id="style_view_01"> 
			...
			<td>  
			   ...
			   objRs.close
				...
				계좌번호 <input type="text" name="g_bank_no" class="txtbox" value="<%=g_bank_no%>" size="25" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); EnterNextFocus('frm_custom_regist','g_bank_name');" onBlur="BlurColor(this)"></td>
			<th> 예 금 주 </th>
			<td>
		...
		<tr> 
			...
			<td>
				...
				계좌번호 <input type="text" name="g_sp_bank_acount" class="txtbox" value="<%=g_sp_bank_acount%>" size="25" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); EnterNextFocus('frm_custom_regist','g_sp_bank_name');" onBlur="BlurColor(this)"></td>
			<th> 예 금 주 </th>
			<td>
  ...
  %>
				<tr height='25'>
					...
					<td class="con4"><nobr><span style='color:<%=gaetong_color%>;'><%=gaetong_name%></span>
						<% If session_m_step="M" Then %>
						<span title="이력글 삭제" onclick="reply_del_ok('a_custom_goods_log_del.asp?board_idx=<%=board_idx%>&g_goods_idx=<%=g_goods_idx%>');" onmouseover="this.style.cursor='hand';">
						<img src="/images/button/btn_reply_delete.gif" border=0 align='absmiddle'>
						</span>
						<% End If %></nobr>
					</td>
