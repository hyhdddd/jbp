...
<tr height='400' valign='top'> 
	<td>
		...
		<ul>
			...
			<li class="txt">전체 고객관리</li>
		</ul>
		</div>

		
		<form id="frm_custom_regist" name="frm_custom_regist" action="a_custom_regist_top_ok.asp" method="post" ENCTYPE="MULTIPART/FORM-DATA"> 
		...
		<tr>						
			<th> 이메일 </th>
			<td> 
				<input type="text" name="c_email" class="txtbox" size="40" style="ime-mode:disabled;" value="<%=c_email%>" OnKeyUp="EnterNextFocus('frm_custom_regist','c_email');"></td>
			<th>  </th>
			<td> </td>
		</tr>
		<Tr height=25>
		...
		<tr id="style_view_01"> 
			...
			<td>
				...
				<option value="0" <% if c_bank_cd="0" then %> selected <% end if %>>::은행::</option> 
				<%
				...
				계좌번호 <input type="text" name="c_bank_no" class="txtbox" value="<%=c_bank_no%>" size="25" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); fncReplaceCheck(this,'/'); EnterNextFocus('frm_custom_regist','c_bank_name');"></td>
			<th> 예 금 주  </th>
			<td>
		...
		<tr> 
			...
			<td>
				...
				계좌번호 <input type="text" name="g_sp_bank_acount" class="txtbox" value="<%=g_sp_bank_acount%>" size="25" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); fncReplaceCheck(this,'/'); EnterNextFocus('frm_custom_regist','g_sp_bank_name');"></td>
			<th>예 금 주 </th>
			<td>
		...
		<tr>
			<th> 회사 선택 </th>
			<td colspan='3'>
				<select name="g_article_idx1" class='txtbox' style="width:150px;"
		...
		<tr> 
			...
			<td colspan='3'>
				...
				<input type="text" class="txtbox" name="g_sp_name" value="<%=g_sp_name%>" size="23" maxlength="23" OnKeyUp="EnterNextFocus('frm_custom_regist','g_sp_price');">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<option value="B" <% If g_sp_give_type="B" Or  g_sp_give_type="C" Then %> selected <% End If %>> 고객센터 지급 </option>
		...
		<Tr  id="style_view_04">
			...
			<td colspan='3' width='900'>				
				...
				<option value="0" <% if g_code_promise_idx="0" then %> selected <% end if %>>약정선택 				
				</select>
		...
		<tr  id="style_view_05"> 
			...
			<td colspan='3'>
				...
				<option value="B" <% If g_sp_give_type1="B" Or g_sp_give_type1="C" Then %> selected <% End If %>> 고객센터 지급 </option>
				<option value="F" <% If g_sp_give_type="F" Then %> selected <% End If %>> 본사상품권 + 현금 </option>
				</select>
			</td>
		</tr>
		...
		<tr> 
			<th>첨부파일1</th>
			<td width='400'> 
				<input type="file" name="g_file1" size="40" class="txtbox">
			...
			<th> 첨부 파일2 </th>
			<td width='400'> 
				<input type="file" name="g_file2" size="40" class="txtbox" 
			onFocus="FocusColor(this);this.select();">
		...
		<tr> 
			<th> 첨부 파일3 </th>
			<td > 
				<input type="file" name="g_file3" size="40" class="txtbox">
			...
			<th> 첨부 파일4 </th>
			<td> 
				<input type="file" name="g_file4" size="40" class="txtbox">
		...
		<div class="button">
			<a href="a_custom_goods_list.asp?page=<%=page%>&nowblock=<%=nowblock%>&<%=s_link_txt%>"><span class="btn_m_white01"> 목록으로</span></a>
			<span onClick="custom_regist_all('A');" onmouseover="this.style.cursor='hand';"><span class="btn_m_white01"> 저장하기</span></span>
		</div>
		</form>
		<!------------------ 내용 시작  ------------------>
	</td>
