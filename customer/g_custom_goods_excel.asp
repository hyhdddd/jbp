  ...
  filename="상부고객상품(20"&Left(Create_code(),10)&").xls"		
...
<tr height='30'>
	...
	<th bgcolor='gray'  width="100">본사사은품명</th>
	...
	<th bgcolor='gray'  width="50">번호이동(기존통신사)</th>
	<th bgcolor='gray'  width="50">번호이동(기존명의자)</th>
	<th bgcolor='gray'  width="50">번호이동(기존 주민번호)</th>
	<th bgcolor='gray'  width="50">번호이동(기존 전화)</th>

	<th bgcolor='gray'  width="150">이메일</th>
	<th bgcolor='gray'  width="100">주민발급일자</th>
...
strSql = strSql & " E.gaetong_name, A.c_name, A.g_article_cnt, A.g_give_type,  M.card_name, A.g_move_company, A.g_move_name, "
strSql = strSql & " A.g_move_jumin1, A.g_move_tel1, A.g_move_jumin2, A.c_jumin_date, A.c_email, "
strSql = strSql & " K.dealer_name as g_trans_out_dealer_name, A.g_sp_price_top, A.g_sp_name_top "
...
strSql = strSql & "				where (A.g_trans_out_dealer='"&m_dealer_code&"')"
...
<tr height='30'>
	...
	<td style="mso-number-format:\@"><%=g_move_company%></td>
	<td style="mso-number-format:\@"><%=g_move_name%></td>
	<td style="mso-number-format:\@"><%=g_move_jumin1%>-<%=g_move_jumin2%></td>
	<td style="mso-number-format:\@"><%=g_move_tel1%></td>

	<td style="mso-number-format:\@"><%=c_email%></td>
	<td style="mso-number-format:\@"><%=c_jumin_date%></td>
