  ...
  <%
  filename="담당고객상품(20"&Left(Create_code(),10)&").xls"		
...
strSql = strSql & " A.g_sum_money_chk, A.g_sum_money_txt, A.g_sp_price_top, A.g_sp_name_top, "
...
strSql = strSql & " E.gaetong_name, A.c_name, A.g_article_cnt, A.g_give_type,  M.card_name,"
