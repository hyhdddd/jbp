  ...
  if g_goods_idx<>"" then
	...
	strSql = strSql & " A.g_sp_bank_code, A.g_sp_bank_acount, A.g_sp_bank_name, A.g_sp_bank_memo, A.g_sp_bank_jumin1, "
	strSql = strSql & " A.g_code_service, A.g_file1, A.g_file2, A.g_file3, A.g_file4,  A.g_receipt_type, A.c_auth_chk,  "
	...
	strSql = strSql & " A.g_date_gaetong_hope, A.g_date_gaetong_hope_time, A.g_sp_bank_jumin2, "
	strSql = strSql & " A.g_move_tel1, A.g_move_name, A.g_move_jumin1, A.g_move_jumin2, A.g_move_date, "
	strSql = strSql & " A.g_move_tel2, A.g_move_company, A.g_move_memo, A.g_sp_name_top, A.g_sp_price_top, "
	...
	strSql = strSql & "				where (A.g_trans_in_dealer in (select m_dealer_code from emp_list_dealer where m_id='"&session_m_id&"'))"
	strSql = strSql & "					and A.g_goods_idx="&g_goods_idx 	
...
<!--
	function custom_consult_reply(form_name)
	{
		...
		frm.action="m_custom_goods_consult_ok.asp";
		frm.submit();
	}

	function reply_del_ok(url)
	{
		ans=confirm("이력글을 삭제하시겠습니까?");
		if(ans==true)
		{
...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<div class="sub_title"><img src="/images/common/sub01_t09.gif" width='1000'></div>


		<form id="frm_custom_regist" name="frm_custom_regist" action="m_custom_goods_regist_ok.asp" ENCTYPE="MULTIPART/FORM-DATA" METHOD="POST"> 
		...
		<Tr>
			...
			<td width="370">
				<input type="text" name="c_name" size="15" class="txtbox" value="<%=c_name%>" maxlength=20 onFocus="FocusColor(this);" OnKeyUp="EnterNextFocus('frm_custom_regist','c_jumin1');">
				&nbsp;
		...
		<tr>
			...
			<td colspan="3">
				...
				<input type="text" id="c_address" name="c_address" class="txtbox" value="<%=c_address%>"  size="80" maxlength="80" onFocus="FocusColor(this);" OnKeyDown="enter_chk('c_tel1');"><img src="/images/button/btn_search01.gif" Border="0" align="absmiddle" style="cursor:pointer;" onclick="sample4_execDaumPostcode('c_zipcode1','c_address');"></td>
		</tr>	
		<tr>
			<th> 전화 </th>
			<Td> 
		...
		<tr>
			...
			<td class='con9'> 상부점 </td>
			<td>
				<select name="g_trans_out_dealer" style="width:150px;">
		...
		<tr>
			...
			<td>
				<select name="dealer_code" style="width:150px;" onchange="change_emp_select(this,'frm_custom_regist',this.selectedIndex);">
					<option value="0">:: 회사 선택::</option>                  												
					<% 
				...
				<select name="g_yuchi_m_id" style="width:100px;">
					<option value="0">::: 유치자 :::</option>
					<% 
					strSql= " select m_id, m_name,m_status from emp_list where m_dealer_code='"&m_dealer_code&"' "
		...
		<Tr>
			...
			<td> 
				<input type="text" name="g_service_no" size="15" class="txtbox" value="<%=g_service_no%>" onFocus="FocusColor(this);">
		...
		<Tr>
			<th>상품선택</th>
			<td>
				<select name="g_article_idx1" style="width:100px;" onFocus="FocusColor(this);"
				onchange="article_change(this,'frm_custom_regist',this.selectedIndex,'R'); area_change(this,'frm_custom_regist',this.selectedIndex);">
				...
				End if
				%>	
				</select><select name="g_option_idx" style="width:130px;" onFocus="FocusColor(this);">
			...
			<th> 셋트유형 </th>
			<td>				
				<select name="g_set" style="width:150px;" onFocus="FocusColor(this);">
		...
		<Tr>		
			<th>상품약정</th>
			<td>
				<select name="g_code_promise1" style="width:150px;" onFocus="FocusColor(this);">
			...
			<th>할인탭</th>
			<td>
				<select name="g_code_sale" style="width:150px;" onFocus="FocusColor(this);">
		...
		<tr>
			<th> 부가서비스 </th>
			<Td> 
				<select name="g_code_service1" style="width:150px;" onFocus="FocusColor(this);">
			...
			<td>
				...
				<img src="/images/Common/icon_help.gif" border="0" align='absmiddle' onmouseover="this.style.cursor='hand';" onclick="alert('SMS전송 - 유치자에게 고객상태 정보를 문자메세지로 전송할 수 있는 기능입니다.');"></td>	
		</tr>
		<tr>
			<th> 지역 선택 </th>
			<td> 
				<select name="g_code_area" style="width:150px;" onFocus="FocusColor(this);">
			...
			<th>해약일자 </th>
			<td>
				<input type="text" name="g_cancel_date" size='10' class="txtbox" value="<%=g_cancel_date%>" readonly
				onblur="BlurColor(this);" 
				onFocus="FocusColor(this);this.select();"><img src="/images/button/btn_calendar.gif" align="absmiddle" onclick="NewWindow('/include/asp/calendar.asp?code1=g_cancel_date&code2=&code3=&form_name=frm_custom_regist','cal_write','250','300','no');" onmouseover="this.style.cursor='hand';">
			</td>	
		</tr>
		<tr>
			<th> 설치 장소 </th>
			<td colspan='3'>
				...
				<input type="text" id="g_address" name="g_address" class="txtbox"  value="<%=g_address%>"  size="80" maxlength="80" onFocus="FocusColor(this);" OnKeyDown="enter_chk('c_tel1');"><img src="/images/button/btn_search01.gif" Border="0" align="absmiddle" style="cursor:pointer;" onclick="sample4_execDaumPostcode('g_zipcode1','g_address');"></td>
		</tr>
		<tr height="30">
		...
		<tr id="style_view_02"> 
			...
			<td>
				...
				카드번호 <input type="text" name="g_card_no" class="txtbox" value="<%=g_card_no%>" size="30" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); fncReplaceCheck(this,'/');"></td>
			<th> 유효기간 </th>
			<td>
		...
		<tr>
			...
			<th>본사사은품 금액 </th>
			<td>
				<input type="text" class="txtbox" name="g_sp_price_top" value="<%=g_sp_price_top%>" size="10" maxlength="6" OnKeyUp="fncOnlyNumber(this);" onFocus="FocusColor(this);" style="ime-mode:disabled" id="g_sp_price_top" onclick="select_price(this.id)">원 
			</td>
		</tr>
		<tr height="30">
		...
		<tr> 
			...
			<th> 사은품 금액 </th>
			<td>
				<input type="text" class="txtbox" name="g_sp_price" value="<%=g_sp_price%>" size="10" maxlength="10"OnKeyUp="fncOnlyNumber(this); EnterNextFocus('frm_custom_regist','g_sp_date_start'); " onFocus="FocusColor(this);" style="ime-mode:disabled"  id="g_sp_price" onclick="select_price(this.id)">원 &nbsp;
			</td>
		</tr>
		<tr>
			<th> 지급예정일 </th>
  ...
  %>
				<tr height="30" style="font-size:11px;">
					<td class="con5"><b>
						<a href="m_custom_goods_regist.asp?g_goods_idx=<%=l_g_goods_idx%>&page=<%=page%>&nowblock=<%=nowblock%>&s_link_txt=<%=Server.URLEncode(s_link_txt)%>"><span title="<%=c_name%>"><%=Left(c_name,10)%></span></a></b></td> 
  ...
  %>
		...
		<div class="button">
			<a href="m_custom_goods_list.asp?g_goods_idx=<%=g_goods_idx%>&page=<%=page%>&nowblock=<%=nowblock%>&<%=s_link_txt%>"><img src="/images/button/btn_list.gif" border=0 align='absmiddle'></a>

			<% if ad_b_m_custom="E" or ad_b_m_custom="A" then %>
			...
			<% Else %>
				<a href ='javascript:alert("<%=session_m_name%> 님은 수정 권한이 없습니다. 관리자에 문의하세요!");'><img src="/images/button/btn_save.gif"  border="0" align='absmiddle' onmouseover="this.style.cursor='hand';"></a>
			<% End If %>
