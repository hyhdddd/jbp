 ...
 '사은품 계좌정보
  ...
  g_sp_bank_acount		= WORD_CHANGE(UploadForm("g_sp_bank_acount"),20)						'사은품지급 은행계좌
  g_sp_bank_name		= WORD_CHANGE(UploadForm("g_sp_bank_name"),20)							'사은품지급 은행예금주
  g_sp_bank_memo		= WORD_CHANGE(UploadForm("g_sp_bank_memo"),40)							'사은품지급 은행메모
  ...
  g_sum_money_txt		= WORD_CHANGE(UploadForm("g_sum_money_txt"),40)							'합산청구 텍스트
  ...
  g_move_name			= WORD_CHANGE(UploadForm("g_move_name"),20)
  ...
  '본사사은품
  g_sp_name_top			= WORD_CHANGE(UploadForm("g_sp_name_top"),40)							'본사 사은품 - 이름 
  ...
  Alert_url " 고객 상품이 등록되었습니다.","m_custom_goods_list.asp?g_goods_idx="&g_goods_idx&"&page="&page&"&nowblock="&nowblock&"&"&s_link_txt
  %>