...
<tr height='400' valign='top'> 
	<td>
		...
		<ul>
			...
			<li class="txt">담당별 고객관리</li>
		</ul>
		</div>

		<form id="frm_custom_regist" name="frm_custom_regist" action="m_custom_regist_top_ok.asp" method="post" ENCTYPE="MULTIPART/FORM-DATA"> 
		...
		<tr  id="style_view_02"> 
			...
			<td>
				...
				카드번호 <input type="text" name="g_card_no" class="txtbox" value="<%=g_card_no%>" size="30" maxlength="30"  style="ime-mode:disabled;" OnKeyUp="fncOnlyNum(this); fncReplaceCheck(this,'.'); fncReplaceCheck(this,','); fncReplaceCheck(this,'/'); EnterNextFocus('frm_custom_regist','c_card_gigan');" onBlur="BlurColor(this)"></td>
			<th> 유효기간 </th>
			<td>
		...
		<tr  id="style_view_05"> 
			...
			<td colspan='3'>
				...
				<option value="G" <% If g_sp_give_type1="G" Then %> selected <% End If %>> 선지급 </option>
		...
		<tr id="style_view_08"> 
			...
			<td colspan='3'>
				...
				<option value="G" <% If g_sp_give_type2="G" Then %> selected <% End If %>> 선지급 </option>
		...
		<div class="button">
			<a href="m_custom_goods_list.asp?page=<%=page%>&nowblock=<%=nowblock%>&<%=s_link_txt%>"><span class="btn_m_white01"> 목록으로</span></a>
