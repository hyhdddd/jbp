  ...
  c_auth_chk			= WORD_CHANGE(UploadForm("c_auth_chk"),20)								'고객인증
  ...
  g_sp_name2			= WORD_CHANGE(UploadForm("g_sp_name2"),20)								'사은품 정보 - 이름 
  ...
  g_move_memo			= WORD_CHANGE(UploadForm("g_move_memo"),50)
  ...
  If black_type="A" Then
	  Alert_url " 입력하신 고객은 블랙리스트 고객으로 주의 고객 입니다. 참고해 주세요!\n\n 고객 상품이 되었습니다.","a_custom_goods_list.asp"
  ElseIf black_type="B" then
	  Alert_url " 입력하신 고객은 블랙리스트 고객으로 경고 고객 입니다. 참고해 주세요!\n\n 고객 상품이 등록되었습니다.","a_custom_goods_list.asp"
  else
	  Alert_url " 고객 상품이 등록되었습니다.","a_custom_goods_list.asp"
  End if
  %>