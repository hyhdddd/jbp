  ...
  c_office_no			= WORD_CHANGE(UploadForm("c_office_no"),50)
  c_office_name			= WORD_CHANGE(UploadForm("c_office_name"),50)
  c_zipcode1			= WORD_CHANGE(UploadForm("c_zipcode1"),20)
  c_zipcode2			= WORD_CHANGE(UploadForm("c_zipcode2"),20)
  c_address				= WORD_CHANGE(UploadForm("c_address"),70)
 ...
 '사은품 계좌정보
  ...
  Alert_url " 고객 상품이 등록되었습니다.","p_custom_goods_list.asp?g_goods_idx="&g_goods_idx&"&page="&page&"&nowblock="&nowblock&"&"&s_link_txt
  DBClose()
  %>