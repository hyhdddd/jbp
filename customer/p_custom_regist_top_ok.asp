  ...
  c_bank_no				= WORD_CHANGE(UploadForm("c_bank_no"),20)								'계좌번호
  ...
  If black_type="A" Then
	  Alert_url " 입력하신 고객은 블랙리스트 고객으로 주의 고객 입니다. 참고해 주세요!\n\n 고객 상품이 되었습니다.","p_custom_goods_list.asp"
  ElseIf black_type="B" then
	  Alert_url " 입력하신 고객은 블랙리스트 고객으로 경고 고객 입니다. 참고해 주세요!\n\n 고객 상품이 등록되었습니다.","p_custom_goods_list.asp"
  else
	  Alert_url " 고객 상품이 등록되었습니다.","p_custom_goods_list.asp"
  End If
