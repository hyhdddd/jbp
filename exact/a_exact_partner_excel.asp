  ...
  filename="전체정산_거래처별(20"&Left(Create_code(),10)&").xls"		
...
<tr height='30'>
	...
	<th bgcolor='gray' rowspan='2'>사업자</th>
...
<tr height=30>
	...
	<td style="mso-number-format:\@"><%=dealer_bank_no%></td>
	<td style="mso-number-format:\@"><%=dealer_bank_name%></td>
...
<Tr height=30>
	...
	<Td><font color='blue'><%=money_change(tt_charge_combine)%></font></td>
