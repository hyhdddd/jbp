  ...
  g_yuchi_m_id			= WORD_CHANGE(Request("g_yuchi_m_id"),0)		'선택된 사원
  g_yuchi_m_id			= split(g_yuchi_m_id,",")
  ...
  for i=0 to ubound(g_yuchi_m_id)

		t_g_yuchi_m_id	= Trim(g_yuchi_m_id(i))

		If t_g_yuchi_m_id<>"" Then
			...
			strSql = strSql & "			where  (A.g_yuchi_m_id='"&t_g_yuchi_m_id&"') "	
