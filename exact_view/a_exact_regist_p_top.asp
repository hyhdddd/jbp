  ...
  s_date_start			= WORD_CHANGE(request("s_date_start"),20)		'검색 날짜 시작일
  s_date_end			= WORD_CHANGE(request("s_date_end"),20)			'검색 날짜 종료일
  s_gaetong_code		= WORD_CHANGE(request("s_gaetong_code"),20)		'개통코드
  g_yuchi_m_id			= WORD_CHANGE(Request("g_yuchi_m_id"),20)		'유치자	
  date_chk				= WORD_CHANGE(Request("date_chk"),20)			'날짜 항목
...
<div class="outerContainer">			
		...
		<tr height=30> 
			<th class="head_Gray_LB"> 정산 내역서 </th>
