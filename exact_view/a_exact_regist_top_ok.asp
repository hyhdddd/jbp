  ...
  e_exact_type		= WORD_CHANGE(UploadForm("e_exact_type"),20)			'개인정산 , 협력점 정산 (Y, P)
  ...
  strSql = strSql & "				where A.g_trans_in_dealer='"&s_dealer_code &"' "
  ...
  Else 
	  ...
	  strSql = strSql & " charge_gongje, charge_gongje_bigo, "
	  strSql = strSql & " charge_promise, charge_sp_top, charge_sp, charge_sale, charge_document, charge_gita, charge_bundle, charge_buga, charge_combine, exact_passwd)"
