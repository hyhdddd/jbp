 ...
 <%
  ...
  if e_exact_idx<>"" then
	strSql = "SELECT * FROM exact_list A left outer join emp_list B ON A.s_yuchi_m_id=B.m_id "
...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<tr height=30> 
			<td class="list_LBR_left" colspan='2' style="padding:3px;">
				<table width='100%' border=0 cellspacing="0" cellpadding="0" class="table_css">
				<tr height='20'>
				...
				<tr height='30'>
					...
					<Td class="list_LBR_center"><%=money_change(tax_price_n)%></td>
				</tr>
				</table>
			</td>
		</tr>
