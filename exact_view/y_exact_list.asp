...
<tr bgcolor="#FFFFFF"  align='center'> 
  ...
  strSql = stRSql & "		where (A.s_dealer_code='"& t_dealer_code&"') "
  strSql = stRSql & "			and A.e_exact_type='Y' "
  ...
  %>			  
		<tr height=30>
			<td class="con5"><%=i%></td>	
			<td class="con2"><a href="y_exact_regist.asp?e_exact_idx=<%=e_exact_idx%>"><%=e_title%> <%=new1%></a></td>	
