...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<!------------------ 내용 시작  ------------------>
		<div class="sub_title"><img src="/images/common/sub02_t04.gif"></div>
 ...
 %> 
					<a href="/gamang/a_gamang_regist.asp?c_m_gamang_idx=<%=c_m_gamang_idx%>" onmouseover='toggle_calendar(document.all.<%="HideShow1"&j%>);' onmouseout='toggle_calendar(document.all.<%="HideShow1"&j%>);'>☞<%=c_m_name%></a><%=new1%><br>
		...
		%> 
				...
				<div class="calendar_month">
						[<a href='a_gamang_diary.asp?calendar_year=<%=calendar_year-1%>&calendar_month=<%=calendar_month%>'><%=calendar_year-1%>년</a>]         					
						[<a href='a_gamang_diary.asp?calendar_year=<%=calendar_year+1%>&calendar_month=<%=calendar_month%>'><%=calendar_year+1%>년</a>]
						<br><br>
						<% for i=1 to 12 %>
						[<a href='a_gamang_diary.asp?calendar_year=<%=calendar_year%>&calendar_month=<%=i%>'><%=i%>월</a>]
						<% next %>
				</div>
				<!------------------ 내용 종료  ------------------>					          		
	</td>
