...
<tr bgcolor="#FFFFFF"  align='center' height='400'> 
	<td valign='top' align='center'>
		...
		<div class="sub_title"><img src="/images/common/sub02_t03.gif"></div>

		<form name='frm_gamang' method='post' action='a_gamang_list.asp'>

		<table width="100%" border="0" cellpadding="0" cellspacing="0" id="board_table3">
		<tr height='30'>
			<td>
				<select name="s_search_key" style="width:110px;font-size:12px;">
				<option value="" <% If s_search_key="" Then %>selected<%end if %>>::날짜 항목::
				<option value="c_m_writeday" <% If s_search_key="c_m_writeday" Then %>selected<%end if %>>접수일
				</select>				
				<input type="text" name="s_date_start" class="txtbox" size='9' value="<%=s_date_start%>" readonly onblur="BlurColor(this);" onFocus="FocusColor(this);this.select();"><img src="/images/button/btn_calendar.gif" align="absmiddle" onclick="NewWindow('/include/asp/calendar.asp?code1=s_date_start&code2=&code3=&form_name=frm_gamang','cal_write','250','300','no');" onmouseover="this.style.cursor='hand';">~<input type="text" name="s_date_end" size='9' class="txtbox"  value="<%=s_date_end%>" readonly onblur="BlurColor(this);" onFocus="FocusColor(this);this.select();"><img src="/images/button/btn_calendar.gif" align="absmiddle" onclick="NewWindow('/include/asp/calendar.asp?code1=s_date_end&code2=&code3=&form_name=frm_gamang','cal_write','250','300','no');" onmouseover="this.style.cursor='hand';"> <span onClick="send_custom_goods('frm_gamang');"><img src="/images/button/btn_search01.gif"  align='absmiddle' border=0></span>	
			</td>
		</tr>
		<tr height=30> 
			<td align="left"  class="table_header2" style="padding-left:5;border-style:none;">
			...
			<td align="right" valign='middle' style="border-style:none;">	
				<a href="a_gamang_excel.asp?<%=s_link_txt%>"><img src="/images/button/btn_excel.gif" border=0 align="absmiddle"></a>
				<% if ad_g_a_gamang="W" OR ad_g_a_gamang="E" OR ad_g_a_gamang="A" then %>
				<a href="a_gamang_regist.asp"><img src="/images/button/btn_new.gif" border="0" align='absmiddle'></a>
				<% else %>
...
%>			  
		<tr height=28>
			<td class='con5'><%=i%></td>
			<td class='con4'>
				<a href="a_gamang_regist.asp?c_m_gamang_idx=<%=c_m_gamang_idx%>&search_key=<%=search_key%>&search_txt=<%=search_txt%>&page=<%=page%>"><%=m_name%></a></td>
...
%>		  
		...
		<div class="pagelist">	
			...
			mychoice=10
			link_url = "a_gamang_list.asp?search_txt="&search_txt&"&search_key="&search_key&"&"
			%>
