  ...
  c_m_name					= WORD_CHANGE(Request("c_m_name"),40)
  ...
  c_m_address				= WORD_CHANGE(Request("c_m_address"),200)
  c_m_htel1					= WORD_CHANGE(Request("c_m_htel1"),20)
  c_m_mtel1					= WORD_CHANGE(Request("c_m_mtel1"),20)
  c_m_use_goods1			= WORD_CHANGE(Request("c_m_use_goods1"),50)
  c_m_use_goods2			= WORD_CHANGE(Request("c_m_use_goods2"),50)
  c_m_use_goods3			= WORD_CHANGE(Request("c_m_use_goods3"),50)
  c_m_use_goods4			= WORD_CHANGE(Request("c_m_use_goods4"),50)
  ...
  c_m_goods					= WORD_CHANGE(Request("c_m_goods"),50)
  ...
  Alert_Url " 가망고객 접수가 완료되었습니다.","a_gamang_list.asp"
  %>