...
<!--
	...
	function custom_consult_reply(form_name)
	{
		...
		frm.action="p_gamang_consult_ok.asp";
		frm.submit();
	}
...
<tr bgcolor="#FFFFFF"  align='center'> 
	<td valign='top' align='center'>
		...
		<form action="p_gamang_regist_ok.asp" method="post" name="frm_gamang"> 
		...
		<div class="button">				
			<% If c_m_gamang_idx<>"" Then %>
				<% if ad_g_p_gamang="E" or ad_g_p_gamang="A" then %>
				...
				<a href="javascript:board_del_ok('p_gamang_regist_del.asp?c_m_gamang_idx=<%=c_m_gamang_idx%>')"><img src="/images/button/btn_delete.gif"  border="0" align='absmiddle'></a> 
