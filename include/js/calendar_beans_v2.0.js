...
function initCal(obj){
	...
	var iconUrl    = obj.iconUrl == null ? " /images/button/btn_calendar.gif" : obj.iconUrl ; 
...
function drawCalForm(id,tId,calType,min,max,todayYN,iconYN,imageUrl){ // tId = 입력창ID				
	...
	if(iconYN == "y"){
		//$(document.body).append("<div id='"+ id +"Icon' style='position:absolute;vertical-align:middle;'><img id='"+ id +"IconImg' src='"+ imageUrl +"'><div>");
		$(document.body).append("<div id='"+ id +"Icon' style='position:absolute;vertical-align:middle;'><div>");
	}
    ...
    for(var i=min;i<=max+2;i++){ html += "<option value=" + i + ">" + i + "</option>"; }
	html += "</select>"
